...
>
  ...
  whileTap={{ scale: 0.97 }}
  href="mailto:alysaemilio@gmail.com?subject=TaskBridge Studio Inquiry"
          ...
          >
            ...
            <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-3">
              <motion.a
                whileHover={{ y: -2, scale: 1.02 }}
                whileTap={{ scale: 0.97 }}
                href="mailto:alysaemilio@gmail.com?subject=TaskBridge Studio - Hire Support"
  ...
  >
    <div>
      ...
      <motion.a
        whileHover={{ y: -2, scale: 1.02 }}
        whileTap={{ scale: 0.97 }}
        href="mailto:alysaemilio@gmail.com?subject=TaskBridge Studio - Start Support"
